...
export const HamburgerMenu: FC<Props> = ({ navLinks, locale }) => {
  ...
  return (
    <>
      ...
      <div className={classNames('absolute p-4 w-svw h-svh inset-0 z-50 flex flex-col gap-2 bg-white -translate-x-full transition-transform duration-300 ease-in-out', isOpen && 'translate-x-0')}>
