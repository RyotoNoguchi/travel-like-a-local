...
export const BookmarkIcon: FC<Props> = ({ strokeColor, width, height, fillColor, hoverStrokeColor, hoverFillColor }) => (
  <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      fill={fillColor}
      strokeWidth="1"
      className={hoverStrokeColor && hoverFillColor ? `transition-colors duration-200 ${hoverStrokeColor} ${hoverFillColor}` : ''}
    />
  </svg>
)
