...
const ServiceIntroductionPage: NextPage<Props> = async ({ params }) => {
  ...
  const formTranslations = {
    name: t('contact.name') || 'お名前',
    email: t('contact.email') || 'メールアドレス',
    message: t('contact.message') || 'メッセージ',
    submit: t('contact.submit') || '送信する',
    success: t('contact.success') || 'お問い合わせを受け付けました。自動返信メールをご確認ください。',
    error: t('contact.error') || '送信中にエラーが発生しました。時間をおいて再度お試しください。',
    sending: t('contact.sending') || '送信中...'
  }
    ...
    <div className="flex flex-col items-center justify-center gap-8 px-4 pb-12 lg:px-3 pt-2 max-w-screen-lg mx-auto">
      ...
      <section className="w-full grid md:grid-cols-2 gap-8 py-12 items-center">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex gap-4 mt-2">
            <a
              href="https://instagram.com/travel_like_a_local.jp"
              target="_blank"
        ...
        <div className="bg-white rounded-lg shadow-md p-8 max-w-3xl mx-auto">
          ...
          <form className="space-y-6">
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="bg-primary-600 text-white font-semibold py-3 px-8 rounded-md hover:bg-primary-700 transition duration-300 shadow-md"
              >
                {t('cta.contactButton')}
              </button>
            </div>
      ...
      <section className="w-full bg-gradient-to-r from-primary-600 to-orange-500 rounded-xl p-8 text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="#contact"
            className="bg-white text-primary-600 font-semibold py-3 px-8 rounded-md hover:bg-gray-100 transition duration-300 shadow-md flex items-center"
          >
            Contact Now
          </a>
          <Link
